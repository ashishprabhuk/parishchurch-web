...
export const ADMIN_ENTITIES: AdminEntityConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Language",
        type: "select",
        options: ["Marathi", "English", "Tamil"],
      },
      { key: "image", label: "Special Occasion Snap/Image URL" },
      { key: "date", label: "Date / Schedule Info" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "zone", label: "Zone" },
      { key: "patron", label: "Patron Saint" },
      { key: "leader", label: "Leader Name" },
      { key: "contact", label: "Contact Phone / Email" },
      { key: "meetingTime", label: "Meeting Schedule" },
      { key: "description", label: "Description", type: "textarea" },
    ],
  },
  {
